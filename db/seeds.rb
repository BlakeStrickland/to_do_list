...
Task.create!(description: "Finish battleship (-___-)", due_on: Date.today, priority: "5", complete: false)
Task.create!(description: "Eat ice cream", due_on: Date.today, priority: "6", complete: false)
